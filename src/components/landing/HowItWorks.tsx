...
import { Mic, PenSquare, Share2 } from "lucide-react";
...
const steps = [
    {
        ...
        description: "Speak freely, paste rough notes, or write half-formed ideas. Authrax is designed for real thinking, not polished inputs.",
        color: "text-primary",
        bg: "bg-primary/20",
    },
    {
        icon: PenSquare,
        title: "Step 2 — Synthesize",
        description: "Your insight is structured into a clear narrative, guided strictly by your Brand DNA.",
        color: "text-accent",
        bg: "bg-accent/20",
    },
    {
        ...
        description: "Review a draft that feels right. Post knowing it represents your thinking accurately.",
        ...
        <section ref={containerRef} id="how-it-works" className="py-24 bg-card/50 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div ref={headerRef} className="text-center mb-20">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">From Insight to Expression.</h2>
                </div>
